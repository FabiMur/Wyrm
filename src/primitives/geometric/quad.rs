...
impl Quad {
    ...
    pub fn new_box(corner_a: Point3, corner_b: Point3, mat: Arc<Material>) -> HittableList {
...
impl Hittable for Quad { 
    fn hit(&self, r: &Ray, ray_t: &mut Interval) -> Option<HitRecord> {
        ...
        if !is_interior(alpha, beta, &mut u, &mut v) {
            return None;
        }
...
fn is_interior(a: f64, b: f64, u: &mut f64, v: &mut f64) -> bool {
